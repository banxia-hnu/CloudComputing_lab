...
//        System.out.println(requestMessage.substring(1,requestMessage.indexOf(Utils.CRLF)));
        int lines = Integer.parseInt(requestMessage.substring(1, requestMessage.indexOf(Utils.CRLF)).trim());
        // split the message

        String[] paras = requestMessage.split(Utils.CRLF);
//        System.out.println("paras长度"+paras.length);
//        for(String s:paras){
...
//        }
        ...
        switch (paras[2]) {
            ...
            case "DEL":
                ...
                break;
            default:
                parasMap.put("METHOD", "Not Implemented");
                break;
        }
    }
